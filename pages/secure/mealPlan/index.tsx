...
const MealPlanPage = () => {
  ...
  const deleteSelectedMealPlans = () => {
    let _mealPlans = mealPlans.filter(
      (val) => !selectedMealPlans.includes(val)
    );
    setMealPlans(_mealPlans);
    setDeleteMealPlansDialog(false);
  ...
  const localFilter = (val: string) => {
    if (val.length > 1) {
      let _mealPlans = [...mealPlans];
      let filtered = _mealPlans.filter(
        (data) =>
      ...
      <React.Fragment>
        <div className="my-2">
          ...
          <Button
            ...
            disabled={!selectedMealPlans || !selectedMealPlans.length}
          />
        </div>
      </React.Fragment>
    );
    ...
    return (
      <>
        <Button
          ...
          onClick={() => editMealPlan(rowData)}
        />
        <Button
          icon="pi pi-trash"
          className="p-button-rounded p-button-warning"
          onClick={() => confirmDeleteMealPlan(rowData)}
        />
      ...
      <div className="col-12">
        <div className="card">
          ...
          <DataTable
            ...
            onSelectionChange={(e) =>
              setSelectedMealPlans(e.value as MealPlan[])
            }
            dataKey="id"
            loading={loading}
            filters={filters1}
          ...
          >
            ...
            <Column
              ...
              filterField="meals"
              filter
              filterElement={mealsFilterTemplate}
            ></Column>
            ...
            <div dir={textFormat}>
              <div className="field">
                ...
                <AutoComplete
                  ...
                  suggestions={sugmealItems}
                  onChange={(e) => onInputChange(e, "meals")}
                />
              </div>
              ...
              <div className="field">
                ...
                <InputText
                  ...
                  className={classNames({
                    "p-invalid": submitted && !mealPlan.name,
                  })}
                />
              </div>
          ...
          <Dialog
            visible={deleteMealPlansDialog}
            style={{ width: "450px" }}
            header="Confirm"
            modal
            footer={deleteMealPlansDialogFooter}
            onHide={hideDeleteMealPlansDialog}
          >
            <div className="flex align-items-center justify-content-center">
              <i
                className="pi pi-exclamation-triangle mr-3"
              ...
              {mealPlan && (
                <span>
                  Are you sure you want to delete the selected MealPlan?
                </span>
              )}
            </div>
          </Dialog>
