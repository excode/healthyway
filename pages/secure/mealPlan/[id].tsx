...
import {MealPlan,MealPlanService,MealPlanKey } from '@services/MealPlan';
...
const MealPlanDetails = () => {
    ...
    const [mealPlan, setMealPlan] = useState<MealPlan>({meals:"",quantity:0,name:"",price:0});
...
if(mealPlan.image!=undefined && mealPlan.image!=''){
    contetnt =<Image  onError={(e:any)=>defaultImage(e)}  onMouseOver={(e:any)=>setCurrentImage(mealPlan.id??'')}  src={imageURL}  alt="image"  preview downloadable width="250" /> ;
}else if(mealPlan.image==undefined || mealPlan.image=='' ){
    contetnt =<Image    onMouseOver={(e:any)=>setCurrentImage(mealPlan.id??'')}  src="/photo_na.png"  alt="image" width="250" /> ;
}
return (
<>
...
<Button  icon="pi pi-upload" severity="secondary"  onClick={(e) => showUploadDialog(mealPlan,'image',acceptFile)} aria-label="Bookmark" style={{
    position: "relative",
    top: "-105px",
    right: "-35px"
  }} /> 
...
<BlockViewer header="MealPlan details"  containerClassName="surface-section px-4 py-8 md:px-6 lg:px-8">
<Toast ref={toast} />
<div className="surface-section">   
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.createBy}</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.createAt}</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.updateBy}</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.updateAt}</div>
        
    </li>       
  
                
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        <div className="text-500 w-6 md:w-2 font-medium">Item Name</div>
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.meals && mealPlan.meals.map((t:any,k:any) => <Chip key={k} label={t}></Chip>) }</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.quantity}</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.name}</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.price}</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.description}</div>
    ...
    <li className="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
        ...
        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{mealPlan.code}</div>
