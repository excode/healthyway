    ...
    return (
      <>
        <Button
          ...
          onClick={() => editMealOrder(rowData)}
        />
        <Button
          icon="pi pi-trash"
          className="p-button-rounded p-button-warning"
          onClick={() => confirmDeleteMealOrder(rowData)}
        />
    ...
    <div className="grid crud-demo">
      <div className="col-12">
        <div className="card">
          ...
          <Dialog
            visible={deleteMealOrderDialog}
            style={{ width: "450px" }}
            header="Confirm"
            modal
            footer={deleteMealOrderDialogFooter}
