        ...
        const onFilter = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            if (value.length === 0) {
                ...
                const filtered = chefs!.filter((chef:Chef) => {
                    return (chef.createBy.toLowerCase().includes(value)||chef.updateBy.toLowerCase().includes(value)||chef.name.toLowerCase().includes(value)||chef.address.toLowerCase().includes(value)||chef.phoneNumber.toLowerCase().includes(value)||chef.kitchen.toLowerCase().includes(value)) ;
                });
                setChefs(filtered);
            }
            ...
            return (
                <div className="col-12">
                    ...
                    {(data.photo!=undefined  ) 
                      ?  <img src={`${config.serverURI}/${data.photo}`} alt={data.createBy} className="my-4 md:my-0 w-9 md:w-10rem shadow-2 mr-5" />
