  ...
  const onFilter = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value.length === 0) {
      ...
      const filtered = mealItems!.filter((mealItem: MealItem) => {
        return (
          mealItem.createBy.toLowerCase().includes(value) ||
          mealItem.updateBy.toLowerCase().includes(value) ||
          mealItem.name.toLowerCase().includes(value) ||
          mealItem.groupName.toLowerCase().includes(value) ||
          mealItem.code.toLowerCase().includes(value) ||
          mealItem.kitchen.toLowerCase().includes(value)
        );
      });
      ...
      <div className="col-12">
        <div className="flex flex-column md:flex-row align-items-center p-3 w-full">
          ...
          <div className="flex-1 flex flex-column align-items-center text-center md:text-left">
            ...
            <div className="mb-2">{data.groupName}</div>
