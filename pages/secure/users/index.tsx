...
kitchen: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.EQUALS }] }
    ...
    return (
            <>
                ...
                <Dropdown value={options.value} options={datacountrys}  onChange={(e) => options.filterCallback(e.value)} optionLabel="name" optionValue="value" placeholder="Any" className="p-column-filter" />
            </>
        );
    }
...
return (
    ...
    <Column showAddButton={false}  field="country" header="Country" sortable  headerStyle={{ minWidth: '10rem' }} filterField="country"   filter filterElement={countryFilterTemplate}  ></Column>
    ...
    <Column showAddButton={false}  field="kitchen" header="Kitchen" sortable  headerStyle={{ minWidth: '10rem' }} filterField="kitchen"   filter filterElement={kitchenFilterTemplate}  ></Column>
    ...
    <div className="field">
        <label htmlFor="firstName">First Name</label>
         <InputText id="firstName" value={users.firstName} onChange={(e) => onInputChange(e, 'firstName')}    required className={classNames({ 'p-invalid': submitted && !users.firstName })} />
    </div>
    ...
    <div className="field">
        <label htmlFor="mobile">Mobile</label>
         <InputText id="mobile" value={users.mobile} onChange={(e) => onInputChange(e, 'mobile')}    />
    </div>
            

    <div className="field">
        <label htmlFor="country">Country</label>
         <Dropdown   id="country" optionLabel="name"  value={users.country} options={datacountrys} onChange={(e) => onInputChange(e, 'country')}  />
    </div>
    ...
    <div className="field">
        <label htmlFor="kitchen">Kitchen</label>
         <Dropdown   id="kitchen"  optionLabel="kitchenName" optionValue="id"  value={users.kitchen} options={datakitchens} onChange={(e) => onInputChange(e, 'kitchen')}  />
    </div>
