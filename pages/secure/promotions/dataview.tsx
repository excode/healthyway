    ...
    import {Promotions,PromotionsQuery, PromotionsService } from '@services/Promotions';
        ...
        const onFilter = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            if (value.length === 0) {
                ...
                const filtered = promotionss!.filter((promotions:Promotions) => {
                    return (promotions.name.toLowerCase().includes(value)||promotions.description.toLowerCase().includes(value)||promotions.discount.toLowerCase().includes(value)) ;
                });
            ...
            return (
                <div className="col-12">
                    ...
                    {(data.image!=undefined  ) 
                      ?  <img src={`${config.serverURI}/${data.image}`} alt={data.name} className="my-4 md:my-0 w-9 md:w-10rem shadow-2 mr-5" />
                      :  <img src={"/photo_na.png"} alt={data.name} className="my-4 md:my-0 w-9 md:w-10rem shadow-2 mr-5" />
                    }
