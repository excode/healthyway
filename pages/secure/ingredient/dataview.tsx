    ...
    import {Ingredient,IngredientQuery, IngredientService } from '@services/Ingredient';
        ...
        const onFilter = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            if (value.length === 0) {
                ...
                const filtered = ingredients!.filter((ingredient:Ingredient) => {
                    return (ingredient.createBy.toLowerCase().includes(value)||ingredient.updateBy.toLowerCase().includes(value)||ingredient.name.toLowerCase().includes(value)||ingredient.unit.toLowerCase().includes(value)||ingredient.description.toLowerCase().includes(value)||ingredient.itemCode.toLowerCase().includes(value)) ;
                });
