...
const DeliveryPage = () => {
  ...
  const deleteSelectedDeliverys = () => {
    let _deliverys = deliverys.filter(
      (val) => !selectedDeliverys.includes(val)
    );
    setDeliverys(_deliverys);
    setDeleteDeliverysDialog(false);
  ...
  const localFilter = (val: string) => {
    if (val.length > 1) {
      ...
      let filtered = _deliverys.filter(
        (data) =>
      ...
      <React.Fragment>
        <div className="my-2">
          ...
          <Button
            ...
            disabled={!selectedDeliverys || !selectedDeliverys.length}
          />
        </div>
      </React.Fragment>
    );
    ...
    return (
      <>
        <Button
          ...
          onClick={() => editDelivery(rowData)}
        />
        <Button
          icon="pi pi-trash"
          className="p-button-rounded p-button-warning"
          onClick={() => confirmDeleteDelivery(rowData)}
        />
      ...
      <div className="col-12">
        <div className="card">
          ...
          <DataTable
            ...
            onSelectionChange={(e) =>
              setSelectedDeliverys(e.value as Delivery[])
            }
            dataKey="id"
            loading={loading}
            filters={filters1}
          ...
          >
            ...
            <Column
              ...
              filter
              filterElement={deliveryStatusFilterTemplate}
            ></Column>
            ...
            <Column
              ...
              dataType="date"
              filter
              filterElement={deliverdateFilterTemplate}
            ></Column>
          ...
          <Dialog
            visible={deleteDeliverysDialog}
            style={{ width: "450px" }}
            header="Confirm"
            modal
            footer={deleteDeliverysDialogFooter}
            onHide={hideDeleteDeliverysDialog}
          >
            <div className="flex align-items-center justify-content-center">
              <i
                className="pi pi-exclamation-triangle mr-3"
