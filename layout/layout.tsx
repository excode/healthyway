  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta
          property="og:title"
          content="uCode.ai and Sakai by PrimeReact | Free Admin Template for NextJS"
        ></meta>
        <meta
          property="og:url"
        ...
        <meta
          ...
          content="The ultimate collection of design-agnostic, flexible and accessible React UI Components.Code automation by uCode.ai"
        />
        <meta
          property="og:image"
